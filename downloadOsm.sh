...
cd input
osmium merge bretagne.osm.pbf pays-de-la-loire.osm.pbf auvergne.osm.pbf rhone-alpes.osm.pbf haute-normandie.osm.pbf basse-normandie.osm.pbf -o cartes.osm.pbf --overwrite
cd ..
